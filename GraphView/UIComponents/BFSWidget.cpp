...
BFSWidget::BFSWidget(QWidget* parent) : QWidget(parent)
{
    ...
    connect(m_runButton, &QPushButton::clicked, this, &BFSWidget::onRunButton);
    ...
    m_runner = std::make_unique<BFSRunner>();
}

void BFSWidget::setStarVertex(Handle handle)
{
    m_startVertexField->setText(std::to_string(handle).c_str());
    m_runButton->setEnabled(true);
}

void BFSWidget::onRunButton()
{
    QtWindow* w{};
    QObject* curr{ this };
